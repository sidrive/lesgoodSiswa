...
import com.lesgood.siswa.BuildConfig;
...
import com.lesgood.siswa.ui.webview.WebViewActivity;
...
public class CompleteOrderActivity extends BaseActivity {
  ...
  public void validate() {
    ...
    if (cancel) {
      ...
      int total = (int) (order.getTotal() + 0.5d);
      String forSignature =
          BuildConfig.MERCHANT_CODE + order.getOid() + total + BuildConfig.MERCHANT_KEY;
  ...
  @OnClick(R.id.method_ritel)
  public void paymentRitel() {
    metode = "FT";
    validate();
  }
}
