...
import com.lesgood.siswa.ui.detail_teacher.DetailTeacherActivity;
...
public class ListGantiGuruActivity extends BaseActivity {
    ...
    @Inject
    ListGantiGuruActivityPresenter presenter;

    @Inject
    ListGantiGuruAdapter adapter;
    ...
    public static void startWithData(BaseActivity activity, String code, String pelajaran){
        Intent intent = new Intent(activity, ListGantiGuruActivity.class);
        if (code != null){
    ...
    protected void setupActivityComponent() {
        BaseApplication.get(this)
                .getUserComponent()
                .plus(new ListGantiGuruActivityModule((this)))
                .inject(this);
    }
    ...
    public void showAddedItem(String item) {
        Log.e("showAddedItem", "ListActivity" + item.toString());
