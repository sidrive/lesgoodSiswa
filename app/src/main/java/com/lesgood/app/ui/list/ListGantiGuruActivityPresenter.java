...
public class ListGantiGuruActivityPresenter implements BasePresenter {
    ...
    public ListGantiGuruActivityPresenter(ListGantiGuruActivity activity, UserService userService, User user ){
